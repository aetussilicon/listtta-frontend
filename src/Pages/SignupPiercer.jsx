...
export default function SignupPiercer() {
                        ...
                        <div className="info-block-container">
                            <div className="first-block">
                                <form action="">
                                    ...
                                    <div className="form-field user-instagram">
                                        <label htmlFor="instagramUrl">Instagram: </label>
                                        <input type="instagramUrl" className="default-input" name="instagramUrl" id="instagramUrl" placeholder="Seu instagram sem o @" value={instagramUrl} onChange={(e) => setInstagramUrl(e.target.value)}/>
                                    </div>
                                </form>
                            </div>
