  ...
  async function fetchCities() {
    try {
      const response = await axios.get(
        baseCitiesUrl + state + "?providers=dados-abertos-br,gov,wikipedia",
        {
          headers: {
    ...
    if (role === "USER") {
      return (
        <form id="user-form" onSubmit={(e) => signupUser(e)}>
          <input
            className="default-input login-form-input"
            type="email"
            placeholder="Email"
            value={email}
            name="email"
          ...
          <div className="checkbox-lgpd-input">
            ...
            />
            <label>
              Você concorda com os <a href="#">Termos de Serviço</a> e a{" "}
              <a href="#">Política de privacidade</a> do LISTTTA.
            </label>
          </div>
          <button className="btn" disabled={!isChecked} type="submit">
            Cadastrar
          </button>
        </form>
      );
      ...
      return (
        <form id="user-form" onSubmit={(e) => signupUser(e)}>
          ...
          <input
            className="default-input login-form-input"
            type="text"
            placeholder="Seu instagram sem o @"
            value={instagramUrl}
            name="instagram"
            onChange={(e) => {
        ...
        <div className="login-signup-container login-type-popup-container">
          <div className="login-type-popup">
            ...
            <div className="login-type-popup-block-one">
              <button
                className="login-type-popup-block"
                onClick={() => {
              ...
              >
                <div className="login-type-popup-block-content">
                  ...
                  <span>
                    <a href="/signup/tattoo">Tatuador</a>
                  </span>
                </div>
              </button>
              <button
            ...
            <div className="login-type-popup-block-two">
              <button
                className="login-type-popup-block block-two"
                onClick={() => {
                  menuClickForUserSignup();
                  setRole("USER");
                }}
    ...
    return (
      <div className="login-popup user-signup-div" id="user-signup">
        ...
        <div className="container login-signup-container signup-container">
          <div className="login-signup-content">{signUpForms()}</div>
        </div>
      </div>
    );
  };
        ...
        <div className="login-signup-container">
          ...
          <div className="login-fields">
            <div className="login-top">
              ...
              <span>
                Já tem uma conta? <a onClick={loginScreenButton}>Entrar</a>
              </span>
            </div>
            <div className="login-buttons">
              ...
              <button onClick={menuClickForUserSelect}>
            ...
            <div className="listtta-terms">
              <p>
                ...
                <a href="#">Termos de Serviço</a> do Listtta e aceita receber
                nossos e-mails ocasionalmente. Leia nossa{" "}
                <a href="#">Política de Privacidade</a> para saber como usamos
                seus dados pessoais.
              </p>
            </div>
          </div>
